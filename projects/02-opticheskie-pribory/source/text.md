...
Оптические приборы представляют собой неотъемлемую часть науки и техники. Микроскопы позволяют исследовать клеточные структуры, телескопы дают возможность наблюдать удалённые космические объекты, а фотоаппараты служат для фиксации изображений. При этом все эти приборы работают на одних и тех же физических принципах: преломлении и отражении света в линзах и зеркалах. Понимание того, как устроены оптические приборы и почему их характеристики различаются, составляет важную часть курса физики и формирует представление о практическом применении законов геометрической оптики.
...
Работа оптических приборов основана на законах геометрической оптики, то есть раздела физики, описывающего распространение света с помощью модели световых лучей. Для построения геометрической оптики вводятся базовые понятия:

- **Точечный источник света** представляет собой источник, размерами которого в условиях данной задачи можно пренебречь.
- **Световой луч** представляет собой геометрическую линию, вдоль которой распространяется энергия световой волны.

Геометрическая оптика базируется на нескольких фундаментальных законах [1].

**Закон прямолинейного распространения света.** В однородной, прозрачной и изотропной среде свет распространяется прямолинейно. Это свойство позволяет описывать свет в виде лучей, то есть прямых линий, указывающих направление распространения световой энергии.
...
где α означает угол падения, β означает угол преломления, а n₁ и n₂ означают абсолютные показатели преломления первой и второй среды соответственно. Преломление света представляет собой основной механизм, за счёт которого работают линзы и, следовательно, большинство оптических приборов.

### 1.2. Линзы и формула тонкой линзы

Линза представляет собой прозрачное тело, ограниченное двумя сферическими поверхностями (или одной сферической и одной плоской). Линзы делятся на два основных типа: собирающие и рассеивающие [1].

Собирающая линза в сечении обычно выпуклая (посередине толще, чем по краям). Она преобразует параллельный пучок лучей в сходящийся, собирая их в одной точке, называемой фокусом. Расстояние от оптического центра линзы до фокуса называется фокусным расстоянием (F).


Рассеивающая линза в сечении обычно вогнутая (по краям толще, чем посередине). Она преобразует параллельный пучок в расходящийся. Фокус рассеивающей линзы является мнимым: продолжения расходящихся лучей пересекаются перед линзой.
...
Оптическими приборами называют устройства, в которых свет преобразуется с помощью линз и зеркал для получения изображения. По способу наблюдения изображения приборы делятся на две группы [2].
...
Лупа является простейшим оптическим прибором, предназначенным для рассматривания мелких объектов с увеличением. Конструктивно лупа представляет собой собирающую линзу с малым фокусным расстоянием (обычно от 10 до 100 мм) [2].

![Ход лучей в лупе](scheme-1-lupa.png)
...
где D₀ обозначает расстояние наилучшего зрения (для нормального глаза принимается равным 25 см), а F обозначает фокусное расстояние лупы. Так, лупа с фокусным расстоянием 5 см даёт увеличение в 5 раз. Типичные значения увеличения лупы составляют от 2 до 10 крат [2], для больших значений применяют сложные лупы, чтобы избежать сильных аберраций.
...
**Устройство.** Объектив представляет собой короткофокусную собирающую линзу, расположенную вблизи исследуемого объекта. Окуляр является собирающей линзой с бо́льшим фокусным расстоянием, через которую наблюдатель рассматривает изображение. Обе линзы закреплены на концах тубуса, цилиндрической трубки фиксированной длины (L).

![Ход лучей в микроскопе](scheme-2-mikroskop.png)
...
Ключевые характеристики. Помимо увеличения, важной характеристикой микроскопа является разрешающая способность, а именно минимальное расстояние между двумя точками объекта, которые прибор различает как отдельные. У оптического микроскопа разрешающая способность ограничена длиной волны видимого света и составляет около 0,2 мкм [3].
...
![Ход лучей в телескопе-рефракторе](scheme-3-teleskop.png)
...
Фотоаппарат является проекционным оптическим прибором, предназначенным для получения и фиксации изображений объектов на светочувствительном материале (плёнке или цифровой матрице) [2].

**Устройство.** Основным оптическим элементом фотоаппарата является объектив, представляющий собой систему линз. Объектив закреплён в передней части светонепроницаемого корпуса; в задней части расположен светочувствительный элемент. Между объективом и матрицей находится затвор и диафрагма.

![Ход лучей в фотоаппарате](scheme-4-fotoapparat.png)
...
![Ход лучей в проекционном аппарате](scheme-5-proektor.png)
...
**Микроскоп и телескоп: одинаковая схема, разные задачи.** Оба прибора состоят из объектива и окуляра, однако их характеристики существенно различаются. Причина заключается в расположении предмета. В микроскопе объект находится вблизи фокуса короткофокусного объектива, что обеспечивает большое линейное увеличение промежуточного изображения. В телескопе объект удалён на практически бесконечное расстояние, и объектив имеет большое фокусное расстояние, поэтому здесь задача состоит не в линейном увеличении, а в увеличении углового размера.
